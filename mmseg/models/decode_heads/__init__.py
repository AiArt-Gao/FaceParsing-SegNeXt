...
from .my_fpn_head import MYFPNHead
from .simple_head import SimpleHead
from .ham_head import LightHamHead
from .fcn_head_contrast import FCNHeadContrast
...
__all__ = [
    ...
    'KernelUpdateHead', 'KernelUpdator', 'MYFPNHead', 'CNNHead', 'SimpleHead',
    'LightHamHead', 'FCNHeadContrast'
]
