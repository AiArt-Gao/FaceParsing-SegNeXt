...
class TFSDataset(CustomDataset):
    """ADE20K dataset.
    ...
    CLASSES = ('BACKGROUND','SKIN','NOSE','RIGHT_EYE','LEFT_EYE','RIGHT_BROW','LEFT_BROW',
               'RIGHT_EAR','LEFT_EAR','MOUTH_INTERIOR','TOP_LIP','BOTTOM_LIP',
               'NECK','HAIR','BEARD','CLOTHING','GLASSES','HEADWEAR','FACEWEAR')
    ...
    def __init__(self, **kwargs):
        super(TFSDataset, self).__init__(
            img_suffix='.png',
