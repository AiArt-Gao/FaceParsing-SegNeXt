...
test_evaluator = dict(type='IoUMetric', iou_metrics=['mIoU'], output_dir='./work_dirs/test/lapa/segformer_b0/format_results')
work_dir = '/data2/jiangnan/mmsegmentation-master/work_dirs/test/lapa/segformer_b0'
#output_dir = '/data2/jiangnan/mmsegmentation-master/out_labels/lapa'  # 预测结果的保存目录
gpu_ids = [1]
auto_resume = False
