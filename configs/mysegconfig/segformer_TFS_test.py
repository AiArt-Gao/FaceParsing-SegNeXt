...
work_dir = './work_dirs/segformer_TFS_b0_TFS_original'
test_evaluator = dict(type='IoUMetric', iou_metrics=['mIoU'], output_dir='./work_dirs/test/TFS/segformer/format_results')
gpu_ids = [1]
auto_resume = False
