...
data_root = '/data2/yuhao/FS2K/FS2K/photo/photo1'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        type='CelebAMaskDataset',
        data_root='/data2/yuhao/FS2K/FS2K',
        img_dir='photo/photo3',
        ann_dir='test/labels',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = '/data2/jiangnan/FS2k/work_dirs/photo1'
test_evaluator = dict(type='IoUMetric', iou_metrics=['mIoU'], output_dir='/data2/jiangnan/FS2k/photo1_labels')
gpu_ids = [1]
auto_resume = False