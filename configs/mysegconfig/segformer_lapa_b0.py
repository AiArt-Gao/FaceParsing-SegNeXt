...
work_dir = './work_dirs/segformer_lapa_b0'
output_dir = '/data/jiangnan/jnGAN/mmsegmentation-master/out_labels/lapa'  # 预测结果的保存目录
os.makedirs(output_dir, exist_ok=True)  # 创建保存结果的目录
gpu_ids = [1]
auto_resume = False
