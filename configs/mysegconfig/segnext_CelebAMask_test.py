...
work_dir = './work_dirs/test/CelebAMask/segnext/log'
test_evaluator = dict(type='IoUMetric', iou_metrics=['mIoU'], output_dir='./work_dirs/test/CelebAMask/segformer/format_results')
gpu_ids = [1]
gpu_ids = [1]
auto_resume = False