...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=[
            ...
            dict(type='PixelContrastLoss', loss_weight=0., ignore_label=255)
        ],
        train_cfg=dict(
            contrast=True,
        ),
...
# load_from = '/data/jiangnan/jnGAN/mmsegmentation-master/work_dirs/swin_lapa_test/20220829.pth'
...
work_dir = './work_dirs/swin_lapa_contrast_test'
gpu_ids = [1]
auto_resume = False
custom_hooks = [dict(
    type='ChangeWeightHook',
    changeiter=5000,
    toweight=0.1,
)]
